...
# fixed = "python eval.py -dataset cifar10 -model_arch wresnet -model_name wrn_40_2 -num_classes 10 -score GAIA -cal_method cal_zero -hook bn -data_dir ./datasets/ -model_path ./checkpoint/models/cifar10_wrn40_2.pth -batch_size 128 -num_workers 2 --type our"
...
# fixed = "python eval.py -dataset cifar10 -model_arch resnet -model_name resnet34 -num_classes 10 -score GAIA -cal_method cal_zero -hook bn -data_dir ./datasets/ -model_path ./checkpoint/models/cifar10_resnet34.pth -batch_size 128 -num_workers 2 --type our"
...
# fixed = "python eval.py -dataset cifar10 -model_arch resnetv2 -model_name BiT-S-R101x1 -num_classes 10 -score GAIA -cal_method cal_zero -hook before_head -data_dir ./datasets/ -model_path ./BiT-S-R101x1-flat-finetune_cifar10.pth.tar -batch_size 16 -num_workers 2 --type our"
...
# fixed = "python eval.py -dataset cifar100 -model_arch resnet -model_name resnet34 -num_classes 100 -score GAIA -cal_method cal_zero -hook bn -data_dir ./datasets/ -model_path ./checkpoint/models/cifar100_resnet34.pth -batch_size 128 -num_workers 2 --type our"
...
# fixed = "python eval.py -dataset cifar100 -model_arch resnetv2 -model_name BiT-S-R101x1 -num_classes 100 -score GAIA -cal_method cal_zero -hook before_head -data_dir ./datasets/ -model_path ./BiT-S-R101x1-flat-finetune_cifar100.pth.tar -batch_size 16 -num_workers 2 --type our"
...
# fixed = "python eval.py -dataset cifar100 -model_arch wresnet -model_name wrn_40_2 -num_classes 100 -score GAIA -cal_method cal_zero -hook bn -data_dir ./datasets/ -model_path ./checkpoint/models/cifar100_wrn40_2.pth -batch_size 128 -num_workers 2 --type our"
...
# fixed = "python eval.py -dataset imagenet -model_arch resnetv2 -model_name BiT-S-R101x1 -num_classes 1000 -score GAIA -cal_method cal_zero -hook before_head -data_dir ./datasets/ -model_path ./BiT-S-R101x1-flat-finetune.pth.tar -batch_size 16 -num_workers 2 --type our"
...
all_fixed = [
    "python eval.py -dataset imagenet -model_arch resnetv2 -model_name BiT-S-R101x1 -num_classes 1000 -score GAIA -cal_method cal_grad_value -hook before_head -data_dir ./datasets/ -model_path ./BiT-S-R101x1-flat-finetune.pth.tar -batch_size 16 -num_workers 0 --type our",
]
