...
KNOWN_MODELS = OrderedDict([
    ...
    ('BiT-M-R50x1_ash', lambda *a, **kw: ResNetV2_ASH([3, 4, 6, 3], 1, *a, **kw)),
    ('BiT-M-R50x3_ash', lambda *a, **kw: ResNetV2_ASH([3, 4, 6, 3], 3, *a, **kw)),
    ('BiT-M-R101x1_ash', lambda *a, **kw: ResNetV2_ASH([3, 4, 23, 3], 1, *a, **kw)),
    ('BiT-M-R101x3_ash', lambda *a, **kw: ResNetV2_ASH([3, 4, 23, 3], 3, *a, **kw)),
    ('BiT-M-R152x2_ash', lambda *a, **kw: ResNetV2_ASH([3, 8, 36, 3], 2, *a, **kw)),
    ('BiT-M-R152x4_ash', lambda *a, **kw: ResNetV2_ASH([3, 8, 36, 3], 4, *a, **kw)),
    ('BiT-S-R50x1_ash', lambda *a, **kw: ResNetV2_ASH([3, 4, 6, 3], 1, *a, **kw)),
    ('BiT-S-R50x3_ash', lambda *a, **kw: ResNetV2_ASH([3, 4, 6, 3], 3, *a, **kw)),
    ('BiT-S-R101x1_ash', lambda *a, **kw: ResNetV2_ASH([3, 4, 23, 3], 1, *a, **kw)),
    ('BiT-S-R101x3_ash', lambda *a, **kw: ResNetV2_ASH([3, 4, 23, 3], 3, *a, **kw)),
    ('BiT-S-R152x2_ash', lambda *a, **kw: ResNetV2_ASH([3, 8, 36, 3], 2, *a, **kw)),
    ('BiT-S-R152x4_ash', lambda *a, **kw: ResNetV2_ASH([3, 8, 36, 3], 4, *a, **kw)),
])
